...
client.user.setStatus('online');
  client.user.setActivity("u.yardım | u.davet | ZeusBotCodeDevelopment");
...
.setTitle('Etiketlediğin Kullanıcı AFK').setDescription(` \n**• __Sebep;__ \`${est}\`**`));
}
}
...
log.send(new Discord.MessageEmbed()
.setTitle('Universal - TAG Çıkarıldı.')
.setColor('#f1c335')
